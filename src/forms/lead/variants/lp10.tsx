...
type DisqualifyReason = "clt" | "terms_declined" | null;
...
export const Lp10LeadFormDialogContent = ({ isOpen, onClose }: LeadFormVariantProps) => {
  const [step, setStep] = useState<"qualify" | "terms" | "disqualified" | "form">("qualify");
