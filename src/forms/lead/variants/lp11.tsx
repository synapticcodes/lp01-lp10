...
export const Lp11LeadFormDialogContent = ({ isOpen, onClose }: LeadFormVariantProps) => {
  const [step, setStep] = useState<"qualify" | "disqualified" | "form">("qualify");
  const [situation, setSituation] = useState<Situation>(null);
  const [isFormSubmitted, setIsFormSubmitted] = useState(false);
  const bloqueioTriagemKey = "lp11TriagemBloqueada";
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      const triagemBloqueada = sessionStorage.getItem(bloqueioTriagemKey) === "true";
      setIsFormSubmitted(hasSubmitted);
      setStep(triagemBloqueada ? "disqualified" : "qualify");
      setSituation(null);
      ...
      <DialogContent className="sm:max-w-md rounded-2xl shadow-[0_20px_40px_rgba(0,0,0,0.2)] border-0 [&>button]:hidden">
        ...
        <DialogHeader className="text-center pt-2">
          ...
          <p className="text-gray-600 text-base font-medium mt-2">
            No momento, esta triagem está disponível apenas para servidores públicos.
          </p>
        </DialogHeader>
        ...
        <div className="mt-6">
          <div className="rounded-xl border border-lavender bg-lavender/10 p-4 text-center">
            ...
            <p className="text-gray-700 text-base">
              Se o seu caso for de servidor público, volte e refaça a triagem selecionando essa
              opção.
            </p>
          </div>
            ...
            <div className="grid gap-3">
              <OptionButton
                ...
                onClick={() => {
                  ...
                  sessionStorage.setItem(bloqueioTriagemKey, "true");
