...
type DisqualifyReason = "clt" | "low_income" | null;
...
export const Lp08LeadFormDialogContent = ({ isOpen, onClose }: LeadFormVariantProps) => {
  const [step, setStep] = useState<"qualify" | "income" | "disqualified" | "form">("qualify");
